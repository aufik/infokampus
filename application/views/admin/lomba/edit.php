                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <!-- <div class="form-group form-float "  class="">
                            ...
                            <form id="form_advanced_validation frmFileUpload" method="POST" action="<?=base_url();?>index.php/admin/lomba/update_proses/<?=$lo->lomba_id?>"  enctype="multipart/form-data">
                            <script>
