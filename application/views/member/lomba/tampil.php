                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a href="<?=base_url();?>index.php/member/lomba/tambah"><button type="button" class="btn btn-primary">Tambah Lomba Baru</button></a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($lom->lomba_deadline >= date("YYYY-m-d") and $lom->status != "Ditolak"){ ?>
                                                    <a href="<?=base_url();?>index.php/member/lomba/edit_lomba/<?=$lom->lomba_id?>"><button type="button" class="btn btn-warning">Edit</button>
                                                    <?php } ?>
                                                </td>
                                            </tr>
